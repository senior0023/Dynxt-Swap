<template>
  <div style="min-height: 100vh;" class="d-flex dust">
    <v-container class="ma-auto">
      <div class="text-h4 text-center mb-12">DYNXT Pre-registration</div>
      <v-card color="black" max-width="600px" class="mx-auto rounded-xl cream-bx-2" :loading="loading">
        <v-card-text class="pa-3 pa-md-12">
          <div class="text-h4 text-center white--text">Registration</div>
          <div class="text-center">
            Fill in the form to register for the Discord Presale!
            Make sure to add in your Discord username and wallet address to get whitelisted
          </div>
